## This Cog are Using pytchat and deep_translator
## If you want to make the langage config, go to line 61('GoogleTranslator`) to set the translation
## And in line 67 and 68 will posting org msg and translated msg

import discord, pytchat, asyncio
